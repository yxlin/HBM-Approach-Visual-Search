...
avgRT.Present <- subset(avgRT1, target=="P")
avgErr.Present <- subset(avgErr1, target=="P")
...
## --------------------------------
boxRT.Err.Present <- subset(avg1, target=="P")
...
jpeg(filename = "./figures/rtErrorBoxBarPresentWolfe.jpeg",
